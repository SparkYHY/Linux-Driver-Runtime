...
typedef enum {
	...
	CSI_PRP_ENC_MEM = _MAKE_CHAN(19, NO_DMA, NO_DMA, NO_DMA, 20), // channel 20
...
// int32_t sw_ipu_init_channel(struct ipu_soc *ipu, ipu_channel_t channel, ipu_channel_params_t *params);
...
// int32_t sw_ipu_init_channel_buffer(struct ipu_soc *ipu, ipu_channel_t channel, ipu_buffer_t type,
// 				   uint32_t pixel_fmt,
// 				   uint16_t width, uint16_t height,
// 				   uint32_t stride,
// 				   ipu_rotate_mode_t rot_mode,
...
// int32_t sw_ipu_update_channel_buffer(struct ipu_soc *ipu, ipu_channel_t channel, ipu_buffer_t type,
// 				  uint32_t bufNum, dma_addr_t phyaddr);
...
// int32_t sw_ipu_enable_channel(struct ipu_soc *ipu, ipu_channel_t channel);
