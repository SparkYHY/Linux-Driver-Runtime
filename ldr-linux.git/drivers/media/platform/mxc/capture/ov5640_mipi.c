			    ...
			    enum ov5640_mode mode, enum ov5640_mode orig_mode)
{
	...
	pr_debug("ov5640_mipi: ov5640_init_mode\n");
	...
	if (mode == ov5640_mode_INIT) {
		...
		ov5640_data.pix.width = 1280;
		ov5640_data.pix.height = 720;
		// ov5640_data.pix.width = 1920;
		// ov5640_data.pix.height = 1080;
		retval = ov5640_download_firmware(pModeSetting, ArySize);
		if (retval < 0)
			goto err;
		...
		pModeSetting = ov5640_setting_30fps_720P_1280_720;
		ArySize = ARRAY_SIZE(ov5640_setting_30fps_720P_1280_720);
...
{
	pr_debug("ov5640_mipi: ioctl_g_ifparm\n");
	if (s == NULL) {
...
static int ioctl_s_power(struct v4l2_int_device *s, int on)
{
	...
	pr_debug("ov5640_mipi: ioctl_s_power\n");
...
{
	pr_debug("ov5640_mipi: ioctl_g_parm\n");
	struct sensor_data *sensor = s->priv;
...
static int ioctl_s_parm(struct v4l2_int_device *s, struct v4l2_streamparm *a)
{
	...
	int ret = 0;
	pr_debug("ov5640_mipi: ioctl_s_parm\n");
...
{
	struct sensor_data *sensor = s->priv;
	pr_debug("ov5640_mipi: ioctl_g_fmt_cap\n");
...
{
	int ret = 0;
	pr_debug("ov5640_mipi: ioctl_g_ctrl\n");
...
{
	int i, j, count = 0;
	pr_debug("ov5640_mipi: ioctl_enum_frameintervals\n");
...
{
	pr_debug("ov5640_mipi: ioctl_g_chip_ident\n");
...
{
	pr_debug("ov5640_mipi: ioctl_enum_fmt_cap\n");
...
{
	pr_debug("ov5640_mipi: ioctl_dev_init\n");
	struct sensor_data *sensor = s->priv;
			...
			const struct i2c_device_id *id)
{
	...
	pr_debug("ov5640_mipi: ov5640_probe\n");
