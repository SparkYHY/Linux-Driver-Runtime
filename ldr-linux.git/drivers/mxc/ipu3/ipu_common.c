...
#include "ipu_optee_smc.h"
#include <linux/tee_drv.h>

// extern int optee_fast_smc(struct thread_smc_args *args);
...
// int32_t sw_ipu_init_channel(struct ipu_soc *ipu, ipu_channel_t cha, ipu_channel_params_t *params)
// {
// 	int ret = 0;
...
// 	args.a0 = OPTEE_SMC_IPU_INIT_CHANNEL;

// 	dev_dbg(ipu->dev, "sw init channel = %d\n", IPU_CHAN_ID(channel));
...
// 	*/
// 	/* prepare args */
// 	args.a1 = params->csi_prp_enc_mem.in_width;
// 	args.a2 = params->csi_prp_enc_mem.in_height;
// 	args.a3 = params->csi_prp_enc_mem.in_pixel_fmt;
// 	args.a4 = params->csi_prp_enc_mem.out_width;
// 	args.a5 = params->csi_prp_enc_mem.out_height;
// 	args.a6 = params->csi_prp_enc_mem.out_pixel_fmt;
// 	args.a7 = params->csi_prp_enc_mem.mipi_id;

// 	ret = optee_fast_smc(&args);
...
// void sw_ipu_uninit_channel(struct ipu_soc *ipu, ipu_channel_t channel)
// {
// 	uint32_t reg;
// 	uint32_t in_dma, out_dma = 0;
// 	int ret;
...
// 	args.a0 = OPTEE_SMC_IPU_UNINIT_CHANNEL;
...
// int32_t sw_ipu_init_channel_buffer(struct ipu_soc *ipu, ipu_channel_t channel,
// 				   ipu_buffer_t type,
// 				   uint32_t pixel_fmt,
// 				   uint16_t width, uint16_t height,
// 				   uint32_t stride,
...
// 	pr_debug("%s(): initialize channel buffer fron the SW.\n", __func__);
...
// 	*/
// 	/* prepare args */
// 	args.a0 = OPTEE_SMC_IPU_INIT_CHANNEL_BUFFER;
// 	args.a1 = pixel_fmt;
// 	args.a2 = width;
// 	args.a3 = height;
// 	args.a4 = stride;
...
// int32_t sw_ipu_update_channel_buffer(struct ipu_soc *ipu, ipu_channel_t channel,
// 				ipu_buffer_t type, uint32_t bufNum, dma_addr_t phyaddr)
// {
// 	int ret = 0;
// 	unsigned long lock_flags;
...
// 	 * a2 - phyaddr
// 	*/
// 	args.a0 = OPTEE_SMC_IPU_UPDATE_CHANNEL_BUFFER;
// 	args.a1 = bufNum;
// 	args.a2 = phyaddr;
...
// int32_t sw_ipu_select_buffer(struct ipu_soc *ipu, ipu_channel_t channel,
// 			ipu_buffer_t type, uint32_t bufNum)
// {
// 	int ret = 0;
// 	unsigned long lock_flags;
...
// 	// if (bufNum == 0) {
// 	// 	ipu_cha_buf0_rdy = ipu->cm_reg + IPU_CHA_BUF0_RDY(ipu->devtype, 20);
// 	// 	pr_debug("ipu->cm_reg: 0x%08x\n", ipu->cm_reg);
// 	// 	pr_debug("ipu_cha_buf0_rdy: 0x%08x\n", ipu_cha_buf0_rdy);
// 	// } else {
// 	// 	ipu_cha_buf1_rdy = ipu->cm_reg + IPU_CHA_BUF1_RDY(ipu->devtype, 20);
// 	// 	pr_debug("ipu->cm_reg: 0x%08x\n", ipu->cm_reg);
// 	// 	pr_debug("ipu_cha_buf1_rdy: 0x%08x\n", ipu_cha_buf1_rdy);
// 	// }
...
// 	 * a1 - bufNum
// 	*/
// 	args.a0 = OPTEE_SMC_IPU_SELECT_BUFFER;
// 	args.a1 = bufNum;
...
// int sw_ipu_enable_channel(struct ipu_soc *ipu, ipu_channel_t channel)
// {
// 	struct thread_smc_args args;
...
// 	args.a0 = OPTEE_SMC_IPU_ENABLE_CHANNEL;
...
// int32_t sw_ipu_disable_channel(struct ipu_soc *ipu, ipu_channel_t channel, bool wait_for_stop)
// {
// 	struct thread_smc_args args;

// 	args.a0 = OPTEE_SMC_IPU_DISABLE_CHANNEL;
...
// int32_t sw_ipu_enable_csi(struct ipu_soc *ipu, uint32_t csi)
// {
// 	uint32_t reg;
// 	struct thread_smc_args args;

// 	args.a0 = OPTEE_SMC_IPU_ENABLE_CSI;
...
// int32_t sw_ipu_disable_csi(struct ipu_soc *ipu, uint32_t csi)
// {
// 	uint32_t reg;
// 	struct thread_smc_args args;

// 	args.a0 = OPTEE_SMC_IPU_DISABLE_CSI;
...
// 	ipu->csi_use_count[csi]--;
// 	if (ipu->csi_use_count[csi] == 0) {
// 		/* update channel 20 eof irq handler */
// 		_ipu_csi_wait4eof(ipu, ipu->csi_channel[csi]);
// 		optee_fast_smc(&args);
// 	}
// 	mutex_unlock(&ipu->mutex_lock);
