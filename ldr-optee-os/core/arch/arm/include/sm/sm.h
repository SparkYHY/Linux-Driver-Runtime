...
/* sm_ctx literaly holds all unbanked registers */
/*
 * ARMv7 RM: B1-1155
 * The ARM core registers and the processor status registers are not Banked
 * between the Secure and the Non-secure states. 
*/
struct sm_ctx {
