...
/*
 * Issued when firing an ldr callback request
 *
 * Register usage:
 * r0/x0	SMC Function ID, TEESMC_OPTEED_LDR_CALLBACK
 */
#define TEESMC_OPTEED_FUNCID_LDR_CALLBACK		9
#define TEESMC_OPTEED_LDR_CALLBACK \
	TEESMC_OPTEED_RV(TEESMC_OPTEED_FUNCID_LDR_CALLBACK)
