...
#ifdef CFG_LDR
extern const uint8_t __csymtab_strings_start[];
#endif
...
extern uint8_t __ldr_heap1_start[];
extern const uint8_t __ldr_heap1_end[];
extern uint8_t __ldr_stack1_start[];
extern const uint8_t __ldr_stack1_end[];
extern uint8_t __ldr_heap2_start[];
extern const uint8_t __ldr_heap2_end[];
extern uint8_t __ldr_stack2_start[];
extern const uint8_t __ldr_stack2_end[];
extern uint8_t __ldr_gate_text_start[];
extern const uint8_t __ldr_gate_text_end[];
